        ...
        <div class="card-table p-0 m-0">    
          ...
          <div class="topo-table">
            ...
            <div class="button-topo-table">
              <b-icon-plus-circle v-b-modal.modal-cadastro-feriado v-b-tooltip.hover.topleft="'Adicionar Usuário'"></b-icon-plus-circle>
            </div>
...
export default Vue.extend({
  ...
  methods: {
    ...
    listarUsuarios(currentpage: number) : void { 
      ...
      RestApiService.get("usuarios/all", '?nomeSistema=SAPEJ')
          .then((response: any) => {            
