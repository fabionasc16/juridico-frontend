<template>
    <div class="card">
        <!-- CARD DE REITERAÇÃO DO PROCESSO -->
            <div>
                <!-- ÁREA DO PROCESSO PRINCIPAL -->
                <b-form style="background-color: #e5e4e2;">
                    <b-form-group class="titulo m-0 p-0" label="Informações do Processo Principal" label-size="lg">
                        <hr />
                    </b-form-group>

                    <!-- 1ª LINHA (Procedimento - Expediente - Tipo - Prazo) -->
                    <div class="row">
                    ...
                    <!-- 2ª LINHA (Órgão - Dt Processo - Dt Receb - Hr Receb) -->
                    <div class="row">
                ...
                <!-- ÁREA DE REITERAÇÃO DO PROCESSO -->
                <b-form>
                    <b-form-group class="titulo m-0 p-0" label="Informações de reiteração do processo" label-size="lg">
                        <hr />
                    </b-form-group>
                    ...
                    <!-- 3ª LINHA (Assunto - Classificação) -->
                    <div class="row">
                    ...
                    <!-- 4ª LINHA (Coluna Esquerda - Coluna Direita) -->
                    <div class="row">
                        <!-- COLUNA ESQUERDA -->
                        <div class="col-7">
                            <!-- CAMPO Objeto -->
