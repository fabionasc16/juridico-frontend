<template>
  <b-container fluid>
    ...
    <b-row>
      ...
      <b-col lg="6" class="my-1">    <!-- INITIAL SORT -->
        <b-form-group label="Initial sort" label-for="initial-sort-select" label-cols-sm="3" label-align-sm="right"
      ...
      <b-col lg="6" class="my-1">    <!-- FILTER (Digitando) -->
      ...
      <b-col lg="6" class="my-1">    <!-- FILTER (Check para filtrar específico) -->
      ...
      <b-col sm="5" md="6" class="my-1">    <!-- PER PAGE (Define quantas linhas aparece na tabela) -->
      ...
      <b-col sm="7" md="6" class="my-1">    <!-- PAGINATION (Responsivo com o PER PAGE) -->
    ...
    <b-table :items="items" :fields="fields" :current-page="currentPage" :per-page="perPage" :filter="filter"
      ...
      <template #cell(actions)="row">     <!-- BOTÕES DA TABELA -->
        <!-- BOTÃO MODAL -->
