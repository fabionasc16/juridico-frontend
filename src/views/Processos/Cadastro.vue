<template>
  <div>
    <header-page :titulo="'Cadastro de processos'" descricao="Adicione novos processos no sistema" />
    <b-container>
      <div class="row">
        <div class="col-12">
          <b-form @submit.prevent="submit" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <b-form-group label="Entrada através de:" class="font col-sm-3 col-md-3 col-lg-3">
                <b-form-select v-model="form.entradaAtraves" @change="exibirCampo()">
                  <b-form-select-option value="null">-- Selecione --</b-form-select-option>
                  <b-form-select-option value="samu">SAMU</b-form-select-option>
                  <b-form-select-option value="policia">Polícia</b-form-select-option>
                </b-form-select>
              </b-form-group>

              <b-form-group label="Registro No.:" class="font col-sm-3 col-md-3 col-lg-3" v-show="exibirRegistro">
                <b-form-input type="text" v-model="form.registro"></b-form-input>
              </b-form-group>
            </div>
            ...
            <div class="row">
              <b-form-group label="Nome:" class="font col-sm-6 col-md-6 col-lg-6">
                <b-form-input :placeholder="'Nome completo'" type="text" v-model="form.nomePaciente"></b-form-input>
              </b-form-group>

              <b-form-group label="Nome da mãe:" class="font col-sm-6 col-md-6 col-lg-6">
                <b-form-input :placeholder="'Nome completo da mãe'" type="text" v-model="form.nomeMae"></b-form-input>
              </b-form-group>
            </div>
            <div class="row">
              ...
              <b-form-group label="CPF:" class="font col-sm-3 col-md-3 col-lg-3">
                <b-form-input :placeholder="'Exemplo: 000.000.000-00'" type="text" v-model="form.cpf"
                  v-mask="'###.###.###-##'"></b-form-input>
              </b-form-group>

              <b-form-group label="CNS:" class="font col-sm-3 col-md-3 col-lg-3">
                <b-form-input :placeholder="'Exemplo: 000.0000.0000.0000'" type="text" v-model="form.cns"
                  v-mask="'###.####.####.####'"></b-form-input>
              </b-form-group>
            </div>

            <div class="row">
              <b-form-group label="Nacionalidade:" class="font col-sm-3 col-md-3 col-lg-3">
                <b-form-select v-model="form.nacionalidade">
                  <b-form-select-option value="brasileiro">Brasileira</b-form-select-option>
                  <b-form-select-option value="estrangeiro">Estrangeira</b-form-select-option>
                </b-form-select>
              </b-form-group>

              <b-form-group label="Sexo:" class="font col-sm-3 col-md-3 col-lg-3">
                <b-form-select size="sm" v-model="form.sexo">
                  ...
                  <b-form-select-option value="não_especificado">Não especificado</b-form-select-option>
                </b-form-select>
              </b-form-group>
            </div>

            <b-form-group class="titulo" label="Características do paciente" label-size="lg">
              <hr />
            </b-form-group>

            <div class="row">
              <b-form-group label="Raça/Etnia:" class="font col-sm-3 col-md-3 col-lg-3">
              ...
              <b-form-group label="Cor dos olhos:" class="font col-sm-3 col-md-3 col-lg-3">
                <b-form-select size="sm" v-model="form.corOlhos">
                  ...
                  <b-form-select-option value="">Desiguais na cor (heterocromia)</b-form-select-option>
                </b-form-select>
              </b-form-group>
              <b-form-group label="Biotipo:" class="font col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="row">
              <b-form-group label="Cor dos cabelos:" class="font col-sm-3 col-md-3 col-lg-3">
              ...
              <b-form-group label="Tipo do cabelo:" class="font col-sm-3 col-md-3 col-lg-3">
              ...
              <b-form-group label="Corte do cabelo:" class="font col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="row">
              <b-form-group label="Estatura aproximada:" append="m" class="font col-sm-3 col-md-3 col-lg-3"
                description="Em metros">
                <b-form-input type="text" v-model="form.estaturaAproximada" v-mask="'#.##'"></b-form-input>
              </b-form-group>
            ...
            <div class="row">
              <b-form-group label="Sinais particulares:" description=" (tatuagem, cicatriz, marcas etc.)"
                class="font col-sm-10 col-md-10 col-lg-10">
                <b-form-input type="text" v-model="form.sinaisParticulares"></b-form-input>
              </b-form-group>

              <b-form-group label="Acessórios utilizados:" description="(anel, cordão, relógio etc)"
                class="font col-sm-10 col-md-10 col-lg-10">
                <b-form-input type="text" v-model="form.acessoriosUtilizados"></b-form-input>
              </b-form-group>

              <b-form-group label="Deficiência, amputações e/ou deformações? Se sim, qual(is)?"
                class="font col-sm-10 col-md-10 col-lg-10">
                <b-form-input type="text" v-model="form.deficiencia"></b-form-input>
              </b-form-group>
            </div>
            <b-form-group class="titulo" label="Circunstâncias em que foi encontrado(a)" label-size="lg">
              <hr />
            </b-form-group>
            <div class="row">
              ...
              <b-form-group label="Foto do Paciente:" class="font col-sm-8 col-md-8 col-lg-8">
                <b-form-file id="file" accept=".jpg, .png" v-model="form.file" placeholder="Selecione uma foto"
                  drop-placeholder="Drop file here..." @change="handleFileUpload"></b-form-file>
              </b-form-group>
            </div>
